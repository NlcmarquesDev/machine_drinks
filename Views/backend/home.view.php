            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="/drink_machine_vdab/orders">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="/drink_machine_vdab/products">
                    ...
                    <ul class="nav flex-column mb-auto">
                        <a class="nav-link d-flex align-items-center gap-2" href="/drink_machine_vdab/logout">
